# Candidate Reranking: Bi-Encoders vs Cross-Encoders

## 1. What It Is
Two-stage retrieval architectures: fast high-recall candidate retrieval followed by high-precision reranking.
