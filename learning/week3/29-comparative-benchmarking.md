# A/B Strategy Benchmarking: Vector vs Hybrid+Rerank

## 1. What It Is
Empirical evidence demonstrating hit rate and precision gains of Hybrid+Reranker over baseline Vector search.
